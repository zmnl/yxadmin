...
app.service('loginRecordService', function($http) {
	...
	//搜索
	this.draw1 = function() {
		return $http.get("/loginRecord/getLoginRecord");
	}
	//搜索
	this.showLoginRecord = function(page, rows) {
		return $http.get("/loginRecord/showLoginRecord?pageNum=" + page + "&pageSize=" + rows);
	}
});